...
try:
    ...
    print("Please enter your password to install dependent libraries.")
    os.system("sudo pip install kivy")
...
class LoadingScreen(App):
    def build(self):
        ...
        return Image(source = 'LoadingScreen/loading.zip', anim_delay = 0.05, allow_stretch = True,  keep_ratio = True, keep_data = True)
